...
public class Application {
    ...
    public CommandLineRunner demo(EmployeeRepository employeeRepository) {
        return (args) -> {
            ...
            employeeRepository.findById(1).ifPresent(employee -> log.info(employee.toString()));
            ...
            employeeRepository.findByDepartmentIdInAndSalaryBetween(Arrays.asList(1), 2900.0, 3100.0).forEach(employee -> log.info(employee.toString()));
